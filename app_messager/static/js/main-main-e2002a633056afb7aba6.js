...
/***/ "./src/scripts/services/handlers/messages/old-message/sendler-old-message.ts":
/*!***********************************************************************************!*\
  !*** ./src/scripts/services/handlers/messages/old-message/sendler-old-message.ts ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _sendler_message__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../sendler_message */ \"./src/scripts/services/handlers/messages/sendler_message.ts\");\n/* harmony import */ var _sub_handler_suhandler_click__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../sub-handler/suhandler-click */ \"./src/scripts/services/handlers/messages/sub-handler/suhandler-click.ts\");\n/* harmony import */ var _sub_handler_subhandler_key__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../sub-handler/subhandler-key */ \"./src/scripts/services/handlers/messages/sub-handler/subhandler-key.ts\");\n/* harmony import */ var _sub_handler_subhandler_old_post__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../sub-handler/subhandler-old-post */ \"./src/scripts/services/handlers/messages/sub-handler/subhandler-old-post.ts\");\n\n\n\n\nconst sendlerOldMessageTotal = () => {\n  const messageFormHTML = document.getElementById('message');\n  messageFormHTML.removeEventListener('click', (0,_sub_handler_suhandler_click__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(() => {}));\n  messageFormHTML.removeEventListener('keyup', (0,_sub_handler_subhandler_key__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(() => {}));\n  const result = e => {\n    const inputHtml = messageFormHTML.querySelector('messager');\n    if (inputHtml === null) {\n      return;\n    }\n    const inputValue = inputHtml.value.length > 0 ? inputHtml.value.trim() : '';\n\n    /* ------ LocalStorage for old's message ------ */\n    const localS = localStorage.getItem('data');\n    const localSJson = JSON.parse(localS);\n    localSJson.message = inputValue;\n    localStorage.setItem('data', JSON.stringify(localSJson));\n    debugger;\n    const response = (0,_sub_handler_subhandler_old_post__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(e); // проверить входещее событие пустышку\n    (0,_sendler_message__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(true);\n  };\n  messageFormHTML.removeEventListener('click', result);\n  messageFormHTML.removeEventListener('keyup', result);\n  debugger;\n  messageFormHTML.addEventListener('click', result);\n  messageFormHTML.addEventListener('keyup', result);\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (sendlerOldMessageTotal);\n\n//# sourceURL=webpack://shop/./src/scripts/services/handlers/messages/old-message/sendler-old-message.ts?");
